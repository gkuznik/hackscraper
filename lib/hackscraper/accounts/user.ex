defmodule HackScraper.Accounts.User do
  use Ecto.Schema
  import Ecto.Changeset

  @derive {
    Flop.Schema,
    sortable: [:email, :name, :confirmed_at],
    filterable: [:role, :confirmed_at, :name_or_email],
    adapter_opts: [
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, HackScraper.Repo)
  ...
  """
  def valid_password?(%HackScraper.Accounts.User{hashed_password: hashed_password}, password)
