defmodule HackScraperWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("hackscraper.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("hackscraper.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("hackscraper.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("hackscraper.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("hackscraper.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
