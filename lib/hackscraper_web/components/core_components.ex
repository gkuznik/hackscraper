defmodule HackScraperWeb.CoreComponents do
  ...
  @doc """
  Renders an image input that supports both a URL text field and drag-and-drop file upload.
  """
  ...
  def image_upload_input(assigns) do
    ...
    <div class="space-y-3">
      ...
      >
        ...
        <div :if={Enum.empty?(@upload.entries)} class="text-center pointer-events-none">
          <.icon
        ...
        <div :for={entry <- @upload.entries} class="w-full">
  ...
  defp error_to_string(_), do: "invalid upload"
end
