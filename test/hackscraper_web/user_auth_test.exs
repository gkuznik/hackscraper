defmodule HackScraperWeb.UserAuthTest do
  use HackScraperWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias HackScraper.Accounts
  alias HackScraperWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HackScraperWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HackScraperWeb.Endpoint.subscribe(live_socket_id)
